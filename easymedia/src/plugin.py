...
# FIXME from Components.PluginList import *
...
def MPcallbackFunc(answer):
	...
	if answer == "PLAYMOVIES":
		...
		if fileExists(resolveFilename(SCOPE_PLUGINS, "Extensions/MyTube/plugin.pyo")):
			from Plugins.Extensions.MyTube.plugin import MyTubeMain # FIXME
		...
		if fileExists(resolveFilename(SCOPE_PLUGINS, "Extensions/VlcPlayer/plugin.pyo")):
			from Plugins.Extensions.VlcPlayer.plugin import main # FIXME
			main(EMsession)
		else:
